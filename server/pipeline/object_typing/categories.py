...
OBJECT_CATEGORIES: Final[dict[str, list[str]]] = {
    ...
    "tree":         ["a photo of a tree", "a photo of a large isolated tree", "a photo of a palm tree or oak"],
...
ENVIRONMENT_CATEGORIES: Final[dict[str, list[str]]] = {
    ...
    "forest":       ["a photo of a forest", "a photo of dense trees or woodland", "a photo of a wooded area"],
