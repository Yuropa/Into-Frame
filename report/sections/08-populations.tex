...
Instances per square meter is computed from the exemplar count over the exemplar
...
meadow is flowers to the horizon and only the nearest meter resolves into
