...
\midrule
Captioning          & BLIP~\cite{li2022blipbootstrappinglanguageimagepretraining} & Scene and per-crop captions; alternative: Florence-2~\cite{xiao2024florence2} \\
Material captioning & Florence-2~\cite{xiao2024florence2} & Grounds terrain tile prompts in the real crop \\
...
Classification      & CLIP~\cite{radford2021learningtransferablevisual} & Fixed category set \\
Verification        & Grounding DINO~\cite{liu2024groundingdino} & Independent label corroboration \\
Similarity          & DINOv2~\cite{oquab2024dinov2} & Appearance clustering into buckets \\
