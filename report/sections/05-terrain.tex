...
\begin{figure}[htbp]
  ...
  the \SI{200}{\meter} grid with the camera at the center. Only the small region
  around the camera carries direct measurements (a); the radial structure there is
  the projection of panorama columns onto the grid, and the streaks are the spokes
  removed in \cref{sec:despoke}. Completion fills the remaining
  $\sim$\SI{89}{\percent} of cells (b), and erosion adds drainage structure to the
  invented relief (c). The difference between (b) and (c) is deliberately small:
