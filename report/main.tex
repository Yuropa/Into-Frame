...
\input{sections/04-panorama}
\input{sections/05-terrain}
\input{sections/06-texturing}
\input{sections/07-objects}
\input{sections/08-populations}
\input{sections/09-lighting}
\input{sections/10-implementation}
\input{sections/11-results}
\input{sections/12-conclusions}
